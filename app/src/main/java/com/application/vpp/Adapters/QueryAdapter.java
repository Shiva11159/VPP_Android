...
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_query_status2, parent, false);
...
//
//        if (itemList1.get(position).getStatus().trim().equals("Open")) {
...
//
//        TextView txtstatusopen, txtstatusclose, txtDate, txtQuery, txt_remark, txt_token;
//        CardView card_view;
...
//            txt_remark = itemView.findViewById(R.id.txtqueryremark);
