...
package com.application.vpp.Adapters.lib_recyclerViewHeader;
 ...
 */
public class LeadListHeaderDecoration extends RecyclerView.ItemDecoration {
     ...
     */
    public LeadListHeaderDecoration(StickyHeaderAdapter adapter) {
        this(adapter, false);
    }
     ...
     * @param adapter the sticky header adapter to use
     */
    public LeadListHeaderDecoration(StickyHeaderAdapter adapter, boolean renderInline) {
        mAdapter = adapter;
