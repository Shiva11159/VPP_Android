...
public class Signature {
    ...
    public static String calculateRFC2104HMAC(String data, String secret) throws java.security.SignatureException {
        String result;
        try {
            System.out.println("Data : " + data + " , Secret : " + secret);

            // get an hmac_sha256 key from the raw secret bytes
            SecretKeySpec signingKey = new SecretKeySpec(secret.trim().getBytes(), HMAC_SHA256_ALGORITHM);
            ...
            byte[] rawHmac = mac.doFinal(data.trim().getBytes());
