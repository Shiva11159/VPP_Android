...
public class PanValidation extends AppCompatActivity implements NetProcess, RequestSent, ConnectionProcess {
    TextView txtName, txtWarning;
    RelativeLayout layName;
    ConstraintLayout layout_pan_validation;
    FancyButton btnSubmitPAN, btnProceedPAN, btnEdtName, btnsubmitName, btnLogin;
    EditText edtPan;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtPan = findViewById(R.id.editPanNo);
        ...
        btnSubmitPAN.setOnClickListener(new View.OnClickListener() {
            @Override
                    ...
                    try {
                        ...
                        if (status == 0) {
                          //  TastyToast.makeText(getApplicationContext(), message, TastyToast.LENGTH_LONG, TastyToast.INFO);
                           ...
                           // AlertDialogClass.ShowMsg(PanValidation.this, " "+message);
