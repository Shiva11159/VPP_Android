package com.application.vpp.videorecorder.core;
...
//			profile.audioSampleRate = AudioTrack.getNativeOutputSampleRate(AudioManager.STREAM_MUSIC);
			...
			Log.e( "quality=",profile.quality+", vfw = "+profile.videoFrameWidth+", vfh = "+profile.videoFrameHeight);
			Log.e("RECORDERprofileaudio",profile.audioBitRate+", chanel="+profile.audioChannels
